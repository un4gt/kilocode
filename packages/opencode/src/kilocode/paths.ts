...
export namespace KilocodePaths {
   ...
   * - macOS: ~/Library/Application Support/Code/User/globalStorage/un4gt.kilocode-lite
   * - Windows: %APPDATA%/Code/User/globalStorage/un4gt.kilocode-lite
   * - Linux: ~/.config/Code/User/globalStorage/un4gt.kilocode-lite
   */
  export function vscodeGlobalStorage(): string {
    const home = os.homedir()
    switch (process.platform) {
      case "darwin":
        return path.join(home, "Library", "Application Support", "Code", "User", "globalStorage", "un4gt.kilocode-lite")
      case "win32":
        return path.join(
      ...
      default:
        return path.join(home, ".config", "Code", "User", "globalStorage", "un4gt.kilocode-lite")
    }
  }
