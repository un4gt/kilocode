...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "kilocode-- Autocomplete（已禁用）",
  ...
  "kilocode:autocomplete.input.title": "kilocode--: 快速任务",
  "kilocode:autocomplete.input.placeholder": "例如：'重构这个函数使其更高效'",
  "kilocode:autocomplete.commands.generateSuggestions": "kilocode--: 生成建议编辑",
  ...
  "kilocode:autocomplete.codeAction.title": "kilocode--: 建议编辑",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "kilocode-- Autocomplete 被与 GitHub Copilot 的冲突阻止。要解决此问题，你必须禁用 Copilot 的内联建议。",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "kilocode-- Autocomplete 已暂停，因为你的账户没有剩余额度。请添加额度以恢复自动补全。",
  "kilocode:autocomplete.creditsExhausted.addCredits": "添加额度",
  "kilocode:autocomplete.authError.message": "kilocode-- Autocomplete 因身份验证错误已暂停。请重新登录。",
}
