...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "kilocode-- Autocomplete (devre dışı)",
  ...
  "kilocode:autocomplete.input.title": "kilocode--: Hızlı Görev",
  "kilocode:autocomplete.input.placeholder": "örn., 'bu fonksiyonu daha verimli olacak şekilde yeniden düzenle'",
  "kilocode:autocomplete.commands.generateSuggestions": "kilocode--: Önerilen Düzenlemeler Oluştur",
  ...
  "kilocode:autocomplete.codeAction.title": "kilocode--: Önerilen Düzenlemeler",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "kilocode-- Autocomplete, GitHub Copilot ile bir çakışma nedeniyle engelleniyor. Bunu düzeltmek için Copilot'un satır içi önerilerini devre dışı bırakmalısın.",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "Hesabında kalan kredin olmadığı için kilocode-- Autocomplete duraklatıldı. Otomatik tamamlamayı sürdürmek için kredi ekle.",
  "kilocode:autocomplete.creditsExhausted.addCredits": "Kredi Ekle",
  "kilocode:autocomplete.authError.message":
    "Bir kimlik doğrulama hatası nedeniyle kilocode-- Autocomplete duraklatıldı. Lütfen tekrar giriş yap.",
}
