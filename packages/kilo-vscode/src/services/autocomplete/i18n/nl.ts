...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "kilocode-- Autocomplete (uitgeschakeld)",
  ...
  "kilocode:autocomplete.input.title": "kilocode--: Snelle taak",
  "kilocode:autocomplete.input.placeholder": "bijv. 'herschrijf deze functie om efficiënter te zijn'",
  "kilocode:autocomplete.commands.generateSuggestions": "kilocode--: Voorgestelde bewerkingen genereren",
  ...
  "kilocode:autocomplete.codeAction.title": "kilocode--: Voorgestelde bewerkingen",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "De kilocode-- Autocomplete wordt geblokkeerd door een conflict met GitHub Copilot. Om dit op te lossen, moet je de inline suggesties van Copilot uitschakelen.",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "kilocode-- Autocomplete is gepauzeerd omdat je account geen tegoed meer heeft. Voeg tegoed toe om autocomplete te hervatten.",
  "kilocode:autocomplete.creditsExhausted.addCredits": "Tegoed toevoegen",
  "kilocode:autocomplete.authError.message":
    "kilocode-- Autocomplete is gepauzeerd vanwege een authenticatiefout. Meld je opnieuw aan.",
}
