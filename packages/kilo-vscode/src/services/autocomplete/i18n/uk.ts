...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "kilocode-- Autocomplete (вимкнено)",
  ...
  "kilocode:autocomplete.input.title": "kilocode--: Швидке Завдання",
  "kilocode:autocomplete.input.placeholder": "напр., 'рефактори цю функцію для більшої ефективності'",
  "kilocode:autocomplete.commands.generateSuggestions": "kilocode--: Генерувати Запропоновані Правки",
  ...
  "kilocode:autocomplete.codeAction.title": "kilocode--: Запропоновані Правки",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "kilocode-- Autocomplete блокується конфліктом з GitHub Copilot. Щоб виправити це, ти повинен вимкнути вбудовані пропозиції Copilot.",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "kilocode-- Autocomplete призупинено, оскільки на твоєму обліковому записі не залишилося кредитів. Додай кредити, щоб відновити автодоповнення.",
  "kilocode:autocomplete.creditsExhausted.addCredits": "Додати кредити",
  "kilocode:autocomplete.authError.message":
    "kilocode-- Autocomplete призупинено через помилку автентифікації. Будь ласка, увійди знову.",
}
