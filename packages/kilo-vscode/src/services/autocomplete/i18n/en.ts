...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "kilocode-- Autocomplete (disabled)",
  ...
  "kilocode:autocomplete.input.title": "kilocode--: Quick Task",
  "kilocode:autocomplete.input.placeholder": "e.g., 'refactor this function to be more efficient'",
  "kilocode:autocomplete.commands.generateSuggestions": "kilocode--: Generate Suggested Edits",
  ...
  "kilocode:autocomplete.codeAction.title": "kilocode--: Suggested Edits",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "The kilocode-- Autocomplete is being blocked by a conflict with GitHub Copilot. To fix this, you must disable Copilot's inline suggestions.",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "kilocode-- Autocomplete has been paused because your account has no remaining credits. Add credits to resume autocomplete.",
  "kilocode:autocomplete.creditsExhausted.addCredits": "Add Credits",
  "kilocode:autocomplete.authError.message":
    "kilocode-- Autocomplete has been paused due to an authentication error. Please sign in again.",
}
