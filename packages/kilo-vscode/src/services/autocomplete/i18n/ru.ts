...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "kilocode-- Autocomplete (отключено)",
  ...
  "kilocode:autocomplete.input.title": "kilocode--: Быстрая Задача",
  "kilocode:autocomplete.input.placeholder": "напр., 'рефактори эту функцию для большей эффективности'",
  "kilocode:autocomplete.commands.generateSuggestions": "kilocode--: Генерировать Предлагаемые Правки",
  ...
  "kilocode:autocomplete.codeAction.title": "kilocode--: Предлагаемые Правки",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "kilocode-- Autocomplete блокируется конфликтом с GitHub Copilot. Чтобы исправить это, ты должен отключить встроенные предложения Copilot.",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "kilocode-- Autocomplete приостановлено, так как на твоём аккаунте не осталось кредитов. Добавь кредиты, чтобы возобновить автодополнение.",
  "kilocode:autocomplete.creditsExhausted.addCredits": "Добавить кредиты",
  "kilocode:autocomplete.authError.message":
    "kilocode-- Autocomplete приостановлено из-за ошибки аутентификации. Пожалуйста, войди снова.",
}
