...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "kilocode-- Autocomplete (deshabilitado)",
  ...
  "kilocode:autocomplete.input.title": "kilocode--: Tarea Rápida",
  "kilocode:autocomplete.input.placeholder": "ej., 'refactoriza esta función para que sea más eficiente'",
  "kilocode:autocomplete.commands.generateSuggestions": "kilocode--: Generar Ediciones Sugeridas",
  ...
  "kilocode:autocomplete.codeAction.title": "kilocode--: Ediciones Sugeridas",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "El kilocode-- Autocomplete está siendo bloqueado por un conflicto con GitHub Copilot. Para solucionarlo, debes desactivar las sugerencias en línea de Copilot.",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "kilocode-- Autocomplete se ha pausado porque tu cuenta no tiene créditos restantes. Añade créditos para reanudar el autocompletado.",
  "kilocode:autocomplete.creditsExhausted.addCredits": "Añadir créditos",
  "kilocode:autocomplete.authError.message":
    "kilocode-- Autocomplete se ha pausado debido a un error de autenticación. Por favor, inicia sesión de nuevo.",
}
