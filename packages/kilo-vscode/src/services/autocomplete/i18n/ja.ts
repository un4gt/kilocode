...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "kilocode-- Autocomplete（無効）",
  ...
  "kilocode:autocomplete.input.title": "kilocode--: クイックタスク",
  "kilocode:autocomplete.input.placeholder": "例：「この関数をより効率的にリファクタリングして」",
  "kilocode:autocomplete.commands.generateSuggestions": "kilocode--: 編集提案を生成",
  ...
  "kilocode:autocomplete.codeAction.title": "kilocode--: 編集提案",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "kilocode-- AutocompleteがGitHub Copilotとの競合によってブロックされています。これを修正するには、Copilotのインライン提案を無効にする必要があります。",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "アカウントのクレジットが残っていないため、kilocode-- Autocompleteが一時停止されました。オートコンプリートを再開するにはクレジットを追加してください。",
  "kilocode:autocomplete.creditsExhausted.addCredits": "クレジットを追加",
  "kilocode:autocomplete.authError.message":
    "認証エラーのため、kilocode-- Autocompleteが一時停止されました。再度サインインしてください。",
}
