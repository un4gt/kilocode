...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "kilocode-- Autocomplete (wyłączone)",
  ...
  "kilocode:autocomplete.input.title": "kilocode--: Szybkie Zadanie",
  "kilocode:autocomplete.input.placeholder": "np. 'zrefaktoruj tę funkcję, aby była bardziej wydajna'",
  "kilocode:autocomplete.commands.generateSuggestions": "kilocode--: Generuj Sugerowane Edycje",
  ...
  "kilocode:autocomplete.codeAction.title": "kilocode--: Sugerowane Edycje",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "kilocode-- Autocomplete jest blokowane przez konflikt z GitHub Copilot. Aby to naprawić, musisz wyłączyć sugestie inline Copilot.",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "kilocode-- Autocomplete zostało wstrzymane, ponieważ na twoim koncie nie ma pozostałych kredytów. Dodaj kredyty, aby wznowić autouzupełnianie.",
  "kilocode:autocomplete.creditsExhausted.addCredits": "Dodaj kredyty",
  "kilocode:autocomplete.authError.message":
    "kilocode-- Autocomplete zostało wstrzymane z powodu błędu uwierzytelniania. Zaloguj się ponownie.",
}
