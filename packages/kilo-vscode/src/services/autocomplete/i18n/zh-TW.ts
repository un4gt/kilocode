...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "kilocode-- Autocomplete（已停用）",
  ...
  "kilocode:autocomplete.input.title": "kilocode--：快速任務",
  "kilocode:autocomplete.input.placeholder": "例如「重構此函式以提升效率」",
  "kilocode:autocomplete.commands.generateSuggestions": "kilocode--：產生建議編輯",
  ...
  "kilocode:autocomplete.codeAction.title": "kilocode--：建議編輯",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "kilocode-- Autocomplete 因與 GitHub Copilot 衝突而被封鎖。若要修正此問題，必須停用 Copilot 的行內建議。",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "kilocode-- Autocomplete 已暫停，因為你的帳戶沒有剩餘額度。請新增額度以恢復自動補齊。",
  "kilocode:autocomplete.creditsExhausted.addCredits": "新增額度",
  "kilocode:autocomplete.authError.message": "kilocode-- Autocomplete 因驗證錯誤已暫停。請重新登入。",
}
