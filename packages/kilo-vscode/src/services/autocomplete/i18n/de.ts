...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.basic": "kilocode-- Autocomplete",
  "kilocode:autocomplete.statusBar.tooltip.disabled": "kilocode-- Autocomplete (deaktiviert)",
  ...
  "kilocode:autocomplete.toggleMessage": "kilocode-- Autocomplete {{status}}",
  "kilocode:autocomplete.progress.title": "kilocode--",
  ...
  "kilocode:autocomplete.input.title": "kilocode--: Schnellaufgabe",
  "kilocode:autocomplete.input.placeholder": "z.B. 'refaktoriere diese Funktion für mehr Effizienz'",
  "kilocode:autocomplete.commands.generateSuggestions": "kilocode--: Bearbeitungsvorschläge generieren",
  ...
  "kilocode:autocomplete.commands.category": "kilocode--",
  "kilocode:autocomplete.codeAction.title": "kilocode--: Bearbeitungsvorschläge",
  "kilocode:autocomplete.chatParticipant.fullName": "kilocode-- Agent",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "Das kilocode-- Autocomplete wird durch einen Konflikt mit GitHub Copilot blockiert. Um dies zu beheben, musst du Copilots Inline-Vorschläge deaktivieren.",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "kilocode-- Autocomplete wurde pausiert, weil dein Konto kein Guthaben mehr hat. Füge Guthaben hinzu, um Autocomplete fortzusetzen.",
  "kilocode:autocomplete.creditsExhausted.addCredits": "Guthaben hinzufügen",
  "kilocode:autocomplete.authError.message":
    "kilocode-- Autocomplete wurde aufgrund eines Authentifizierungsfehlers pausiert. Bitte melde dich erneut an.",
}
