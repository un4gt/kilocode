...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "kilocode-- Autocomplete (अक्षम)",
  ...
  "kilocode:autocomplete.input.title": "kilocode--: त्वरित कार्य",
  "kilocode:autocomplete.input.placeholder": "जैसे, 'इस फ़ंक्शन को अधिक कुशल बनाने के लिए रिफैक्टर करें'",
  "kilocode:autocomplete.commands.generateSuggestions": "kilocode--: सुझाए गए संपादन जेनरेट करें",
  ...
  "kilocode:autocomplete.codeAction.title": "kilocode--: सुझाए गए संपादन",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "kilocode-- Autocomplete को GitHub Copilot के साथ संघर्ष के कारण ब्लॉक किया जा रहा है। इसे ठीक करने के लिए, आपको Copilot के इनलाइन सुझावों को अक्षम करना होगा।",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "kilocode-- Autocomplete रोक दिया गया है क्योंकि आपके खाते में शेष क्रेडिट नहीं है। ऑटोकम्प्लीट फिर से शुरू करने के लिए क्रेडिट जोड़ें।",
  "kilocode:autocomplete.creditsExhausted.addCredits": "क्रेडिट जोड़ें",
  "kilocode:autocomplete.authError.message":
    "प्रमाणीकरण त्रुटि के कारण kilocode-- Autocomplete रोक दिया गया है। कृपया फिर से साइन इन करें।",
}
