...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "kilocode-- Autocomplete (desactivat)",
  ...
  "kilocode:autocomplete.input.title": "kilocode--: Tasca Ràpida",
  "kilocode:autocomplete.input.placeholder": "p. ex., 'refactoritza aquesta funció per ser més eficient'",
  "kilocode:autocomplete.commands.generateSuggestions": "kilocode--: Generar Edicions Suggerides",
  ...
  "kilocode:autocomplete.codeAction.title": "kilocode--: Edicions Suggerides",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "El kilocode-- Autocomplete està sent bloquejat per un conflicte amb GitHub Copilot. Per solucionar això, has de desactivar els suggeriments en línia de Copilot.",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "kilocode-- Autocomplete s'ha pausat perquè el teu compte no té crèdits restants. Afegeix crèdits per reprendre l'autocompletat.",
  "kilocode:autocomplete.creditsExhausted.addCredits": "Afegir crèdits",
  "kilocode:autocomplete.authError.message":
    "kilocode-- Autocomplete s'ha pausat a causa d'un error d'autenticació. Si us plau, torna a iniciar sessió.",
}
