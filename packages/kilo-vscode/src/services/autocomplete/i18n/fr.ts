...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "kilocode-- Autocomplete (désactivé)",
  ...
  "kilocode:autocomplete.input.title": "kilocode-- : Tâche Rapide",
  "kilocode:autocomplete.input.placeholder": "ex., 'refactorise cette fonction pour plus d'efficacité'",
  "kilocode:autocomplete.commands.generateSuggestions": "kilocode-- : Générer des Modifications Suggérées",
  ...
  "kilocode:autocomplete.codeAction.title": "kilocode-- : Modifications Suggérées",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "Le kilocode-- Autocomplete est bloqué par un conflit avec GitHub Copilot. Pour résoudre cela, tu dois désactiver les suggestions en ligne de Copilot.",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "kilocode-- Autocomplete a été mis en pause car ton compte n'a plus de crédits. Ajoute des crédits pour reprendre l'autocomplétion.",
  "kilocode:autocomplete.creditsExhausted.addCredits": "Ajouter des crédits",
  "kilocode:autocomplete.authError.message":
    "kilocode-- Autocomplete a été mis en pause en raison d'une erreur d'authentification. Veuillez te reconnecter.",
}
