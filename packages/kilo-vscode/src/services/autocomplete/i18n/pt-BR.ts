...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "kilocode-- Autocomplete (desabilitado)",
  ...
  "kilocode:autocomplete.input.title": "kilocode--: Tarefa Rápida",
  "kilocode:autocomplete.input.placeholder": "ex., 'refatore esta função para ser mais eficiente'",
  "kilocode:autocomplete.commands.generateSuggestions": "kilocode--: Gerar Edições Sugeridas",
  ...
  "kilocode:autocomplete.codeAction.title": "kilocode--: Edições Sugeridas",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "O kilocode-- Autocomplete está sendo bloqueado por um conflito com o GitHub Copilot. Para corrigir isso, você deve desabilitar as sugestões inline do Copilot.",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "O kilocode-- Autocomplete foi pausado porque sua conta não tem créditos restantes. Adicione créditos para retomar o autocompletar.",
  "kilocode:autocomplete.creditsExhausted.addCredits": "Adicionar créditos",
  "kilocode:autocomplete.authError.message":
    "O kilocode-- Autocomplete foi pausado devido a um erro de autenticação. Por favor, faça login novamente.",
}
