...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.disabled": "kilocode-- Autocomplete (đã tắt)",
  ...
  "kilocode:autocomplete.input.title": "kilocode--: Tác Vụ Nhanh",
  "kilocode:autocomplete.input.placeholder": "ví dụ, 'tái cấu trúc hàm này để hiệu quả hơn'",
  "kilocode:autocomplete.commands.generateSuggestions": "kilocode--: Tạo Các Chỉnh Sửa Được Đề Xuất",
  ...
  "kilocode:autocomplete.codeAction.title": "kilocode--: Các Chỉnh Sửa Được Đề Xuất",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "kilocode-- Autocomplete đang bị chặn do xung đột với GitHub Copilot. Để khắc phục điều này, bạn phải tắt các gợi ý inline của Copilot.",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "kilocode-- Autocomplete đã bị tạm dừng vì tài khoản của bạn không còn tín dụng. Thêm tín dụng để tiếp tục sử dụng tự động hoàn thành.",
  "kilocode:autocomplete.creditsExhausted.addCredits": "Thêm tín dụng",
  "kilocode:autocomplete.authError.message":
    "kilocode-- Autocomplete đã bị tạm dừng do lỗi xác thực. Vui lòng đăng nhập lại.",
}
