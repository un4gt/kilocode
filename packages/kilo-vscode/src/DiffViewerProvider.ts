...
export class DiffViewerProvider implements vscode.Disposable {
  public static readonly viewType = "kilocode-lite.new.DiffViewerPanel"
  ...
  private onMessage(msg: Record<string, unknown>): void {
    ...
    if (type === "webviewReady") {
      this.post({
        ...
        languageOverride: vscode.workspace.getConfiguration("kilocode-lite.new").get<string>("language"),
