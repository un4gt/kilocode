export const dict = {
  ...
  "deviceAuth.title": "Zaloguj się do kilocode--",
  ...
  "profile.action.login": "Zaloguj się przez kilocode--",
  ...
  "settings.aboutKiloCode.title": "O kilocode--",

  "session.messages.empty": "Rozpocznij rozmowę, wpisując wiadomość poniżej.",
  "session.messages.welcome":
    "kilocode-- to asystent programowania AI. Poproś go o tworzenie funkcji, naprawę błędów lub wyjaśnienie bazy kodu.",
  ...
  "settings.aboutKiloCode.extensionName": "Rozszerzenie kilocode--",
  ...
  "settings.aboutKiloCode.resetSettings.description":
    "Zresetuj wszystkie ustawienia rozszerzenia kilocode-- do wartości domyślnych. Nie wpływa to na konfigurację CLI ani backendu.",
  ...
  "settings.language.description": 'Wybierz język interfejsu kilocode--. „Auto" używa języka wyświetlania VS Code.',
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Migruj ustawienia z poprzedniej instalacji kilocode--, w tym klucze API dostawców i domyślny model.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Co nowego w kilocode--",
