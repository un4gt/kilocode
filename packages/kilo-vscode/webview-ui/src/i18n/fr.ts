export const dict = {
  ...
  "deviceAuth.title": "Se connecter à kilocode--",
  ...
  "profile.action.login": "Se connecter avec kilocode--",
  ...
  "settings.aboutKiloCode.title": "À propos de kilocode--",

  "session.messages.empty": "Commencez une conversation en tapant un message ci-dessous.",
  "session.messages.welcome":
    "kilocode-- est un assistant de programmation IA. Demandez-lui de créer des fonctionnalités, corriger des bugs ou expliquer votre code.",
  ...
  "settings.aboutKiloCode.extensionName": "Extension kilocode--",
  ...
  "settings.aboutKiloCode.resetSettings.description":
    "Réinitialiser tous les paramètres de l'extension kilocode-- à leurs valeurs par défaut. Cela n'affecte pas la configuration CLI ou backend.",
  ...
  "settings.language.description":
    "Choisissez la langue de l'interface de kilocode--. \"Auto\" utilise la langue d'affichage de VS Code.",
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Migrer les paramètres d'une précédente installation de kilocode--, y compris les clés d'API des fournisseurs et le modèle par défaut.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Nouveautés de kilocode--",
